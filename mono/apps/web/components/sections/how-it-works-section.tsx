...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="w-full py-20 bg-purpl-50">
      ...
      <div className="container grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-background p-6 rounded-lg text-center space-y-4 bg-green-100">
        ...
        <div className="bg-background p-6 rounded-lg text-center space-y-4 bg-orange-100">
        ...
        <div className="bg-background p-6 rounded-lg text-center space-y-4 bg-cyan-100">

    ...
    <div className="space-y-6">
      ...
      <div className="border border-border rounded-lg overflow-hidden bg-card">
        ...
        <div className="p-6 space-y-4">
          {[1, 2, 3, 4, 5].map((num) => (
            <div key={num} className="p-4 border border-border rounded-lg bg-background">
              <div className="flex justify-between items-center">
              ...
              <div className="space-y-2 mt-4">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full border border-border flex items-center justify-center text-xs">A</div>
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full border border-border flex items-center justify-center text-xs">B</div>
                  <div>Protein synthesis</div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full border border-border flex items-center justify-center text-xs">C</div>
                  <div>Cell division</div>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full border border-border flex items-center justify-center text-xs">D</div>
